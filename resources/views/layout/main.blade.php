...
<html lang="en">
  <head>
    ...
    <meta name="keywords" content="agriculture, elevage, pêche, solution agricole, marché numérique, afrique">
    <meta name="author" content="AgroMarket">
    <link rel="icon" type="image/png" href="{{ asset('asset/favicon.ico') }}" />
    
    <!-- Favicons
    ================================================== -->
  {{--   <link rel="shortcut icon" href="{{ asset('asset/img/apple-touch-icon.png') }}" type="image/x-icon">
    ...
    <link rel="stylesheet" href="{{ asset('asset/css/nivo_lightbox_themes/default/default.css') }}">
    ...
    <script type="text/javascript" src="{{asset('asset/js/modernizr.custom.js') }}"></script>
   ...
   <!-- jQuery (necessary for Bootstrap's JavaScript plugins) -->
    ...
    <script type="text/javascript" src="{{ asset('asset/js/owl.carousel.js') }}"></script><!-- Owl Carousel Plugin -->
    ...
    <!-- Parallax Effects -->
    <script type="text/javascript" src="{{ asset('asset/js/skrollr.js') }}"></script>
    <script type="text/javascript" src="{{ asset('asset/js/imagesloaded.js') }}"></script>

    <!-- Portfolio Filter -->
    <script type="text/javascript" src="{{ asset('asset/js/jquery.isotope.js') }}"></script>

    <!-- LightBox Nivo -->
    <script type="text/javascript" src="{{ asset('asset/js/nivo-lightbox.min.js') }}"></script>

    <!-- Contact page-->
    <script type="text/javascript" src="{{ asset('asset/js/jqBootstrapValidation.js') }}"></script>
    <script type="text/javascript" src="{{ asset('asset/js/contact.js') }}"></script>
